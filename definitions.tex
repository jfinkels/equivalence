...
The definitions of these complexity classes produce a chain of inclusions beginning with $\NPEqEight$ at the bottom and terminating with $\NPEqOne$ at the top (\autoref{fig:inclusions}).
\begin{figure}
