...
\begin{proof}
  ...
  \todo{I don't quite see how to get this next sentence; it seems to come from the fact that the image of $K$ under $f$ is infinite (if it were finite, the problem would be in $\P$).}
