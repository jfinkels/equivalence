...
We adapted Schöning's Uniform Diagonalization Theorem \autocite{schoning}, a generalized version of Ladner's Theorem, to classes of equivalence problems.
The specific proof presentation we follow is from \autocite{bdg95}.
