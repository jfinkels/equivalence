...
It is straightforward to prove that $R$ and $S$ are equivalence relations so we omit the proof.
...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{scope}
        %% Rectangles representing equivalence classes of R.
        \node[anchor=east] (0, 0) {$\dotsb$};
        \fill[color=lightgray]
        ++(0, -0.05) rectangle ++(1, 0.1)
        ++(0.1, -0.1) rectangle ++(1, 0.1)
        ++(0.1, -0.1) rectangle ++(1, 0.1)
        ++(0, -0.05) node[color=black, anchor=west] {$\dotsb$};
      ...
      \begin{scope}[shift={(0, -1.5)}]
        ...
        \node[anchor=east] (0, 0) {$\dotsb$};
        \fill[color=lightgray]
        ++(0, -0.05) rectangle ++(2.2, 0.1)
        ++(0.1, -0.1) rectangle ++(2, 0.1)
        ++(0, -0.05) node[color=black, anchor=west] {$\dotsb$};
      ...
      \begin{scope}[dot/.style={circle, fill=black, inner sep=1.2pt},
                    arrow/.style={->, >=stealth}]
        \node[dot] (source) at (1.6, 0) {};
        \node[dot] (target) at (2, -1.5) {};
        \path[arrow] (source) edge node[fill=white] {$f_n$} (target);
      \end{scope}
    \end{tikzpicture}
  \end{center}
