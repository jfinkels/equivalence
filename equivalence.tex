...
\begin{lemma}
  If there exists a $\NPcoNP$ algorithm $A$ that decides whether $\pair{M}{n}$ is in \lang{EQUIV} within time $n^{f(|M|)}$ for some computable function $f$, then the language
  \begin{align*}
    R = {} & \{\pair{u}{v}|u=v\} \\
