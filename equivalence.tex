...
\begin{theorem}\label{thm:reduction_ce}
  ...
  countably infinite, then $R\krnt S$.
\end{theorem}
\begin{proof}
  Since countably infinite sets are computably enumerable, let $r_1, r_2,
  \ldots$ and $s_1, s_2, \ldots$ be enumerations of representatives of
  equivalence classes for $R$ and $S$ respectively. Let $M$ be the Turing
  machine which decides $R$. Define the function $f$ as in
