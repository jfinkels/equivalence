...
\section
    ...
    %{Relationship between completeness \\ under kernel and many-one reductions}
    {Completeness in kernel versus many-one reductions}
...
If $\PEq = \NPEq$, then the $\NP$-complete equivalence relation in \autoref{ex:npceqrel} is decidable in polynomial time, thus $\P = \NP$.
