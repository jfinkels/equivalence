...
from many-one reductions. We wish to show that there exist two equivalence
relations such that we can construct a many-one reduction but not a kernel
reduction. To do this, we construct an equivalence relation in which
information about \emph{both} elements is necessary for a reduction.
