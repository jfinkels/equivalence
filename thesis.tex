...
\begin{abstract}
  ...
  examine some examples of kernel reductions among easy equivalence relations,
  to show that they make sense. We then examine the complexity of equivalence
  problems which are complete under kernel reductions in \NP. We also show that
  most known many-one reductions among isomorphism problems in $\NP$ are indeed
  kernel reductions.
\end{abstract}
