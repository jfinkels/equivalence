...
\begin{proof}
  ...
  %% TODO provide simply a reference? see the graph isomorphism book
\end{proof}

From \autoref{lem:gi_ke_dirgi}, we can use a kernel reduction to directed graph
isomorphism to show that a language kernel reduces to (undirected) graph
