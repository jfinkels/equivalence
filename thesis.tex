...
\item lattice isomorphism % 13 1->13 [60]
\item isomorphism of commutative nilpotent semigroups of class 3 % 14 1->14
                                                                 % [32]
\item isomorphism of associative algebras of finite rank over a fixed
  ...
  with a commutative factor with respect to the radical % 15 1<->15 [7]
\item context-free grammar isomorphism % [76]
\item balanced incomplete block-scheme isomorphism %[48]
\item etc? % [17, 78, 94] 
