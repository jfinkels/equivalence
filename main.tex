...
% package imports
\usepackage[noend,linesnumbered,ruled]{algorithm2e} % for creating pseudocode algorithms
...
\usepackage{hyperref} % for hyperlinking references in the article
