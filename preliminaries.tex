...
The \defn{equivalence class} of $x$ with respect to an equivalence relation $R$ on $U$ is $\lb y\in U \st (x,y)\in R \rb$.
...
Conversely, a partition of $U$ induces an equivalence relation on $U$ in which a pair of elements is in the relation if they are in the same block of the partition.
