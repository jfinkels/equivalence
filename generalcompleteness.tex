...
$\mathcal{C}$ is \defn{closed under universal quantification} if there exists a language $L''\in\P$ and a polynomial $q$ such that
\begin{displaymath}
...
\begin{proof}
  ...
  Since $M$ is a machine of type $\mathcal{C}$ and $\mathcal{C}$ is closed under both complement and universal quantification, the universal guesses $a,b,$ and $c$ and checking whether the six simulations of $M$ accept or reject do not increase the complexity of this algorithm beyond the class $\mathcal{C}$.
