...
$\forall\mathcal{C}$ is called the \defn{closure of $\mathcal{C}$ under polynomial bounded universal quantification}.
If $\forall\mathcal{C}=\mathcal{C}$ then we say $\mathcal{C}$ is \defn{closed under polynomial bounded universal quantification}.
